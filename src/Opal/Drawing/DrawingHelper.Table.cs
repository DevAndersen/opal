...
public static partial class DrawingHelper
{
    ...
    {
        public (int Width, int Height) DrawTable(int posX,
            int posY,
            int columns,
            int rows,
            int cellWidth,
        ...
        {
            return grid.DrawTable(posX, posY, columns, rows, cellWidth, cellHeight, cellFunc, DrawStyle.StandardDrawStyle, template);
        }
            ...
            ConsoleChar template = default)
        {
            ...
            return grid.DrawTable(posX, posY, cellWidths, cellHeights, cellFunc, style, template);
        }
        ...
        public (int Width, int Height) DrawTable(int posX,
            ...
            ConsoleChar template = default)
        {
            return grid.DrawTable(posX, posY, columnWidths, rowHeights, cellFunc, DrawStyle.StandardDrawStyle, template);
        }
